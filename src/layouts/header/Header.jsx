  ...
  return (
    <div className="container mx-4 md:mx-auto">
      ...
      <div className="flex justify-between">
        <div className="w-full flex flex-col justify-start items-center lg:items-start mb-5 md:mb-0">
          <h1 className="md:w-[410px] mb-1 md:mb-6 text-4xl leading-[85px] lg:text-[85px] font-bold text-black-light">We Create Startups.</h1>
        ...
        <div className="hidden lg:inline-block">
          <img src={Artwork} alt="Artwork" className="h-full w-full md:w-[705px]" />
        </div>
      </div>
    </div>
  );
